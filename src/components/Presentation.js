...
const Presentation = () => {
  ...
  return (
    <Box className="grid grid-cols-1 grid-rows-auto_1fr min-h-content-screen">
      <img src={animation} alt="Loading Animation" className="container max-w-xs xl:max-w-sm 2xl:max-w-md px-5 animate-slide_up_half row-auto mx-auto rounded-full" />
      {moved ? (
        <Box className="p-5 pt-0 md:px-14 md:max-h-64 2xl:max-h-80 row-span-1 flex flex-col justify-evenly items-center md:items-end">
          ...
          <Box className="container max-w-sm flex justify-evenly mt-5 mb-10 flex-wrap gap-3">
