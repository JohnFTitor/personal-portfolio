...
const Contact = () => {
  ...
  return (
    <>
      ...
      <Box component="form" action="https://formspree.io/f/xqknowrz" method="POST" className={`absolute right-0 bottom-0 transition-all ${transform} w-60 lg:w-72 h-96 xl:h-128 bg-secondary-50 dark:bg-zinc-900 border-l-2 border-t-2 border-primary-900 dark:border-secondary-50 p-5 flex-col gap-5 overflow-auto`}>
        ...
        <Input type="text" name="name" placeholder="Enter your name" required className="w-full dark:text-secondary-50" />
        <Input type="email" name="email" placeholder="Enter your email" required className="w-full dark:text-secondary-50" />
        <textarea name="message" className="w-full h-1/2 text-primary-1000 dark:text-secondary-50 bg-secondary-50 dark:bg-zinc-900" placeholder="Would you like to say something? :)" />
