...
const Menu = (props) => {
  ...
  return (
    <Box className={`absolute top-0 left-0 h-screen w-screen sm:w-72 max-w-xs z-10 bg-secondary-1000 rounded-r-large p-8 flex flex-col items-center transition-transform ${translation}`}>
